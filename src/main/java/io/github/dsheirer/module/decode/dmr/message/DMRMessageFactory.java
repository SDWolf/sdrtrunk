                                  ...
                                  long timestamp, int timeslot)
    {
        switch(syncPattern)
        {
            ...
            case DIRECT_MODE_DATA_TIMESLOT_0:
                return DataMessageFactory.create(syncPattern, binaryMessage, cach, timestamp, 0);
            case DIRECT_MODE_DATA_TIMESLOT_1:
                return DataMessageFactory.create(syncPattern, binaryMessage, cach, timestamp, 1);
            case UNKNOWN:
                return null;
